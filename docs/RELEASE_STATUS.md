...
| Investor application | Original SAMA landing, shadcn interface, wallet-bound transaction engine, offering/portfolio/market screens, and five educational routes; 52 frontend tests and a 14-page production build pass at `ef77bc7` | Complete wallet-driven browser acceptance, including failure recovery |
