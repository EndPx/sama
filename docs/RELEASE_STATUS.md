...
| Investor application | Original SAMA landing, shadcn interface, wallet-bound transaction engine, and offering/portfolio/market screens in `fa13d8a`; 50 frontend tests pass locally | Finish production build verification and wallet-driven browser acceptance, including failure recovery |
