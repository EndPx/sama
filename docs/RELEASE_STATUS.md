...
| GitBook documentation | Rewritten English source and 22-page navigation in `docs/`; `node scripts/check-docs.mjs` passes | Publish the new revision and confirm its live sidebar and pages; the current public GitBook is still on an older revision |
